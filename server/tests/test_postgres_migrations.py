...
def test_pg_full_upgrade_downgrade_reupgrade_and_indexes() -> None:
    ...
    try:
        ...
        with psycopg.connect(dsn) as conn:
            ...
            assert version == "031_admin_write_idempotency", f"unexpected head revision: {version}"
...
def test_pg_billing_constraints_downgrade_guard() -> None:
    ...
    try:
        ...
        with pytest.raises(RuntimeError, match="cannot downgrade 026"):
            # Three steps: 031->027 (empty idempotency ledger, symmetric)
        ...
        # downgrade becomes possible again. Three steps (031->027->026->025)
