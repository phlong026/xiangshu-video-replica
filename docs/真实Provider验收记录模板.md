...
P0 必须使用已授权真人 Golden Sample 比较可用候选模型，并选定一个默认实现。自动相似度只作提示，人工审核结论才是角色版本发布依据。

| 检查项 | 结果 | 证据 |
| --- | --- | --- |
| 真实模型别名与输入方式已确认 | 待填写 | 待填写 |
| 一张真人源图可生成 7 类必需视角 | 待填写 | 待填写 |
| 每个 view_type 与实际角度一致 | 待填写 | 待填写 |
| 同一版本人物身份基本一致 | 待填写 | 待填写 |
| 同一版本服装、体型和年龄感基本一致 | 待填写 | 待填写 |
| 无多人、拼图、明显肢体异常、文字或水印 | 待填写 | 待填写 |
| 单张失败可独立重生成 | 待填写 | 待填写 |
| 候选、审核、发布和对象存储可追溯 | 待填写 | 待填写 |
| 耗时、候选数和费用已记录 | 待填写 | 待填写 |

未完成真人 Golden Sample 和人工审核时，该 Provider 必须保持 `SOURCE_PENDING`。
